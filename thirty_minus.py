...
def size(image):
    ...
    for cnt in contours:
        ...
        if aaa>=10000 and aaa<31000:#length>=250 and length<370 and width>=50:
            print(aaa)
        ...
        #elif length>=250 and length<370 and width>=50:
        elif aaa>=31000 and aaa<40000:#length>=370 and length<500 and width>=50:
            print(aaa)
            points = cv2.boxPoints(rect)         # Find four vertices of rectangle from above rect
            points = np.int0(np.around(points))     # Round the values and make it integers
        ...
        elif aaa>=40000 and aaa<=1000000:#length>=500 and length<2000 and width>=50:
            print(aaa)
            points = cv2.boxPoints(rect)         # Find four vertices of rectangle from above rect
            points = np.int0(np.around(points))     # Round the values and make it integers
