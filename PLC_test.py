...
client.write_register(6400, 8, unit=1)	#Gate 1 Delay 
client.write_register(6401, 12, unit=1)	#Gate 2 Delay 
client.write_register(6402, 16, unit=1)	#Gate 3 delay
client.write_register(6403, 20, unit=1)	#Gate 1 Delay 
# client.write_register(6404, 46, unit=1)	#Gate 2 Delay 
client.write_register(6405, 24, unit=1)	#Gate 3 delay Not used


client.write_register(6406, 3, unit=1)	#Gate Open TIme
client.write_register(4116, 60, unit=1)	#Image Capture Delay
    ...
    if (True):
        ...
        if St_Analysis== "True": 
            ...
            try:
                ...
                result0=Infested.Infested(Image0,0)
            except:
                result0='G'
            try:
                result1=Infested.Infested(Image1,1)
            except:
                result1='G'  
            try:
                result2=Infested.Infested(Image2,2)
            except:
                result2='G'                
            ...
            if result0=='M' or result1=='M' or result2=='M':
                print('Result =  M')
                client.write_register(4096,2, unit=1)
